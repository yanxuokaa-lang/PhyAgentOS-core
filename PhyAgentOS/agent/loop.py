        ...
        prompt = json.dumps(
            {
                ...
                "instruction": (
                    ...
                    "facts are obtainable through registered Forge Query tools, materialize those "
                    "discovery nodes before downstream manipulation; do not request user "
                    "clarification for discoverable refs. The Coordinator creates planning_binding "
                    "during selection. "
