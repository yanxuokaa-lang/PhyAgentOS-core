                    ...
                    "properties": {
                        "entity_ref": {
                            ...
                            "description": (
                                ...
                                "scene.bind/scene.understand record. When a unique "
                                "Coordinator-owned node binding exists, PAOS supplies it "
                                "before projection; do not derive or rename it from a color "
                                "or category label."
                            ),
                        },
